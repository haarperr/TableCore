...
GUI.optionRect = {0, 0, 0, 155}
GUI.scroller = {255, 255, 255, 155}
...
local optionTextSize = {0.35, 0.35}
local optionRectSize = {0.23, 0.03}
local menuX = 0.7
...
function Menu.Option(option)
	...
	if(currentOption <= GUI.maxVisOptions and optionCount <= GUI.maxVisOptions) then
		GUI.Text(option, GUI.optionText, {menuX - 0.11, ((menuYOptionAdd - 0.0125) + (optionCount / menuYOptionDiv) * menuYModify)},  optionTextSize, false)
