...
RegisterServerEvent('tb-weathersync:server:RequestStateSync')
AddEventHandler('tb-weathersync:server:RequestStateSync', function()
    TriggerClientEvent('tb-weathersync:client:SyncWeather', -1, CurrentWeather, blackout)
    TriggerClientEvent('tb-weathersync:client:SyncTime', -1, baseTime, timeOffset, freezeTime)
end)
...
function SetWeather(type)
    ...
    TriggerEvent('tb-weathersync:server:RequestStateSync')
end
